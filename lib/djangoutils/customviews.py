...
class RestrictedCreateView(generic.CreateView):
    msg_form_success = _(u'Registered')
    urldo = None
    title_name = None
...
class RestrictedUpdateView(generic.UpdateView):
    ...
    msg_form_success = _(u'Successfully changed')
    msg_form_unchanged = _(u'Not changed')
    urldo = None
    title_name = None
    title_name_plural = None
    url_name = None
...
class RestrictedDeleteView(generic.DeleteView):
    url_name = None
    msg_success = _(u'Successfully removed')
...
class ListFormView(generic.ListView, RestrictedView):
    urldo = None
    title_name = None
    title_name_plural = None
    url_name = None
